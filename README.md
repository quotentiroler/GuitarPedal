...
Nothing here has been run against a physical board yet.  Every number it
has produced so far came from a fault injected into the netlist and
handed back to it, which says the arithmetic works and says nothing about
whether a real measurement is clean enough.
